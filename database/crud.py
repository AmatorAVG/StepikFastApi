...
# wal1 = bit.Key()
# addr = 'mt9YmMHykUsMfD6KEynGAozDfxCWch8akL'
# wallet = bit.PrivateKeyTestnet('cV95NmF4YLYo2DYWrtUxXW2LfK7DBzN96u9XDM6wnTn73tRcGucK')  # наш кошелек готов и содержится в переменной wallet
# print(f"Баланс: {wallet.get_balance()}")
# print(f"Адрес: {wallet.address}")
# print(f"Приватный ключ: {wallet.to_wif()}")
# transaction = wallet.send([('muh9DYMTWXfPEd9zPnfvCS1yX8hPLbkE9e', 5, 'eur')])
# print(transaction)
